...
<Frame>
  <img src="/resources/zadarma-mypbx-extensions.png" alt="Zadarma My Switchboard Extensions" />
</Frame>
...
<Frame>
  <img src="/resources/zadarma-switch-extension-settings.PNG" alt="Zadarma My Switchboard Extensions Settings" />
</Frame>
...
<Frame>
  <img src="/resources/zadarma-sip-settings.png" alt="Zadarma SIP Settings" />
</Frame>

Find the following information:

<Frame>
  <img src="/resources/zadarma-sip-connection-settings.png" alt="Zadarma SIP Connection Settings" />
</Frame>
...
1. Go to Services, Connect number on the main page.
   <Frame>
     <img src="/resources/zadarma-services.png" alt="Zadarma Services" />
   </Frame>

2. Go to Active numbers.
   <Frame>
     <img src="/resources/zadarma-active-numbers.png" alt="Zadarma Active Numbers" />
   </Frame>

3. Click on the number you want to connect and press settings button.
   <Frame>
     <img src="/resources/zadarma-settings-button.png" alt="Zadarma Settings Button" />
   </Frame>
...
<Frame>
  <img src="/resources/zadarma-external-services.png" alt="Zadarma External Services" />
</Frame>
...
3. Click “Integrate SIP trunk”
   ...
   <Frame>
     <img src="/resources/twillio-import-autocalls-sip1.png" alt="Import numbers to Autocalls" />
   </Frame>
...
<Frame>
  <img src="/resources/zadarma-autocalls-type.png" alt="Fill in your details based on your integration type" />
</Frame>

For SIP Connection:

<Frame>
  <img src="/resources/twillio-autocalls-auth-integration.png" alt="Fill in your details based on your integration type" />
</Frame>
...
<Frame>
  <img src="/resources/zadarma-outbound-settings.png" alt="Zadarma Outbound Settings" />
</Frame>
...
* Add the **IPs** from **Zadarma** (Step 1).
  ...
  <Frame>
    <img src="/resources/zadarma-ip-inbound.png" alt="Twillio Autocalls Credentials IP Type" />
  </Frame>

7. Select the country of where your SIP trunk is located.

   <Frame>
     <img src="/resources/twillio-autocalls-sip-country.png" alt="Twillio Autocalls SIP Country" />
   </Frame>
...
<AccordionGroup>
  <Accordion title="After connecting, inbound works but outbound does not work?">
    ...
    * Check your user name and credentials Please make sure you entered the right user name and credentials which shows in this dialog. Please note the user name is not the friendly name that shows in the credential list. The friendly is different to user name, you need to double check if you happen to give a different name.
    ...
    <Frame>
      <img src="/resources/twillio-outbound-not-work.png" alt="Twillio outbound not work" />
    </Frame>
  </Accordion>
  ...
  <Accordion title="How do I set up dialing to international countries?">
    * Search “geo” to find the “Voice Geographic Permissions” setting.
      <Frame>
        <img src="/resources/twillio-setup-dialing-international.png" alt="Twillio setup dialing international" />
      </Frame>
    * Choose “Elastic Sip Trunking” in selector, and select the countries you would like to dial.
      <Frame>
        <img src="/resources/twillio-choose-elastic-sip-trunking.png" alt="Twillio setup dialing international" />
      </Frame>
  </Accordion>
